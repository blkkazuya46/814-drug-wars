...
export const GlobeIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h10a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.707 4.5l.053.053a.5.5 0 010 .707l-.053.053L4.5 8.5l3.254-3.254a.5.5 0 01.707 0zM16.293 4.5l-.053.053a.5.5 0 000 .707l.053.053L19.5 8.5l-3.254-3.254a.5.5 0 00-.707 0zM12 21a9 9 0 100-18 9 9 0 000 18z" />
    </svg>
);